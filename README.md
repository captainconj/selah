...
- **The center verse says "seven days, guard the charge."** The structure's own dimensions (7) appear in its own center's instruction.
- **The turning sword** (Genesis 3:24) is exactly **67 letters** — one complete fiber of the understanding axis.
...
The explorer UI serves at `http://localhost:8099` — oracle, thummim, and translation tools. Ask the breastplate a question. Watch the stones light up.

---

## The Name

סלה (*selah*) appears 74 times in the Psalms and 3 times in Habakkuk. Nobody knows exactly what it means. The best guess: *pause*. Stop reading forward. Look at where you are.

> *Write the vision; make it plain on tablets, so he may run who reads it.*
> — Habakkuk 2:2

We wrote the code. Now you can run it.
