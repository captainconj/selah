...
- Why is OSHB/WLC the primary Torah source for the core 304,850-letter model instead of MAM or another witness?
- Which results are invariant under source-text variation, and which depend on one exact edition?
- How are qere/kethiv decisions handled when they affect counts or coordinates?
- Is there a documented source-of-truth policy for when OSHB, Sefaria, MAM, and Leningrad disagree?

## Coordinate Space

- Which parts of the 4D factorization are treated as discovery versus interpretive overlay?
- What are the best arguments that the `[7 50 13 67]` lens is privileged beyond symbolic fit?
- Which analyses remain meaningful under alternate valid factorizations of 304,850?
- Are there benchmark queries that validate the coordinate engine independently of the paper’s narrative claims?

## Oracle Mechanics

- What is the clearest formal definition of an illumination, a reading, and a phrase in the breastplate model?
...
- Which permutation or resampling tests are the project’s main statistical backbone today?
...
- What code paths are considered most brittle and most in need of direct tests?
...
- Which documents are current entry points versus historical layers that have not been reconciled?
