...
The gate screen is woven from four materials. The oracle classifies each:
...
## The Words at the Gate

Word-by-word oracle of Ex 27:16 / Ex 38:18:
...
The gate instruction starts at d = 63. The gate built starts at d = 53. Both are deep in the understanding axis (d runs 0–66, where 67 = בינה = understanding).

The meeting promise ("I will meet with you," Ex 25:22) sits at d = 0 — the zero of understanding.
...
| | GV | Factors |
|---|-----|---------|
| Gate instruction (Ex 27:16) | 6,866 | 2 × 3,433 |
