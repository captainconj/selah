...
We pass through the gate. A hundred cubits long, fifty wide, five high. Bronze sockets. Silver pillars. White linen hangings on every side.

---

## The Three-Letter Split
...
**עמוד** (pillar, GV = 120). A fixed point. Same GV as **מסך** (the gate screen). The pillar and the covering share Moses' number.
...
Every compass direction is a fixed point:

| Direction | Hebrew | GV | Class | Note |
|-----------|--------|-----|-------|------|
| South | נגב | 55 | **FIXED** | All 4 heads see it |
| North | צפון | 226 | **FIXED** | Aaron dominant (17 counts) |
| West (sea) | ים | **50** | **FIXED** | God dominant. **GV = 50 = jubilee axis** |
| East | מזרח | 255 | **FIXED** | Only God sees it |
| Eastward | קדמה | 149 | **FIXED** | Only Right cherub sees it |

The compass holds. The courtyard is oriented. Every direction knows itself.

**ים (west/sea, GV = 50)** = the jubilee. The b-axis of the 4D space runs 0–49. The west side of the courtyard IS the jubilee dimension. God sees it most clearly (9 readings vs 1–2 for others).

**מזרח (east)** — only God sees it. The sunrise direction, the entrance side, is visible only to the one who sits on the mercy seat facing outward.

---

## The Dimensions

100 cubits long × 50 cubits wide × 5 cubits high.

### As Letters

100 → **ק** (qoph). 50 → **נ** (nun). 5 → **ה** (he).

**קנה** — acquire. Also: reed. Also: Ezekiel's measuring rod.

GV of קנה = 155 = 5 × 31. קנה is a **fixed point** in the basin.

The courtyard's dimensions spell the acquisition. The measuring instrument. Ezekiel saw a man with a measuring reed (קנה, Ezekiel 40:3) standing at the gate. The courtyard IS the reed.

### The Dimensions Verse

Ex 27:18 — GV = **4,599 = 3² × 7 × 73**.

Three squared times completeness times wisdom (חכמה = 73). The courtyard dimensions encode nine × seven × wisdom.

### מאה ↔ אמה

**מאה** (hundred, GV = 46) transforms to **אמה** (cubit, GV = 46). Same letters. Same gematria. The hundred becomes the cubit, the cubit becomes the hundred. Both equal **לוי** (Levi, GV = 46).

The courtyard is 100 cubits long. Hundred and cubit are the same word rearranged. The measurement measures itself. And the Levite is both — the count and the unit.

---

## The East Side: 10 × 137

The east side of the built courtyard (Ex 38:13) has GV = **1,370**.

1,370 = 10 × **137**.

137 = 7 + 50 + 13 + 67 = the axis sum. The sum of all four dimensions of the Torah space. Ishmael's lifespan (Genesis 25:17). The reciprocal of the fine structure constant.

The entrance side carries the number of the whole space. You walk in through the signature.

Its coordinate: **(3, 7, 0, 34)** — a = 3 (center of Torah), b = 7 (completeness), c = 0 (origin of love), d = 34 (half of understanding). The east side sits at the origin of love, at completeness, at the center.

---

## The d-Axis Layers

### Instruction layer (2, 34, 12, *)

```
הבדיםעלשתיצלעתהמזבחבשאתאתונבובלחתתעשהאתוכאשרהראהאתךבהרכןיעשוועשיתאת
```

The poles (הבדים), the altar (המזבח), the sign (את × 4), and then: **כאשר הראה אתך בהר** — *"as He showed you on the mountain."*

The courtyard instruction layer contains the mountain vision. What was seen on Sinai is written here. The pattern given above is the pattern built below.

### Built layer (3, 6, 10, *)

```
תאשרצבאופתחאהלמועדויעשאתהחצרלפאתנגבתימנהקלעיהחצרששמשזרמאהבאמה
```

**אשר צבא ופתח אהל מועד** — "who served at the entrance of the tent of meeting." Then: **ויעש את החצר** — "and he made the court."

The instruction layer says: *as shown on the mountain.* The built layer says: *and he made it.* Vision → execution. Same courtyard, two tellings, two a-values.

---

## The c-axis Descent

| Verse | c-value | Meaning |
|-------|---------|---------|
| Instruction (27:9) | c = 12 | Top of love axis |
| Built (38:9) | c = 10 | — |
| Built east (38:13) | c = 0 | **Origin of love** |

The instruction begins at c = 12, the full span of love. The built east side descends to c = 0, the origin. God's plan starts at the maximum. The execution starts at the beginning.
