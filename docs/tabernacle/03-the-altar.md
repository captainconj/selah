...
## The Dimensions Are Love

5 cubits long × 5 cubits wide × 3 cubits high.

**5 + 5 + 3 = 13 = אהבה (love) = אחד (one).**

The altar dimensions sum to love. The sacrifice is built to the proportions of love. Thirteen, the c-axis of the Torah space. The love axis.

In half-cubits: 10, 10, 6. As letters: **י + י + ו**. GV = **26 = YHWH.**

The altar in cubits = love (13). The altar in half-cubits = the Name (26). And 26 = 2 × 13. The Name is double love. The altar holds both.

---

## The Square Is Burning

**רבוע** (square, GV = 278). "Square shall be the altar."

The oracle reads burning in the square:

| Reader | Top readings | Counts |
|--------|-------------|--------|
| Aaron | **בעור / בערו** (Beor / they burned) | 42 + 42 |
| God | **ובער / בעור** (and he burned) | 18 + 18 |
| Right | **בעור / בערו** | 18 + 18 |
| Left | **עברו / בערו** (they crossed / burned) | 37 + 31 |

Every head reads **burning** (בער) in the shape "square." The altar is square because the square IS fire. The shape is the function. The geometry is the verb.

Left cherub also sees **עברו** — "they crossed over." The square is both burning and crossing. The sacrifice burns, and they pass through.

---

## Four = I Will Cross Over

**ארבע** (four, GV = 273 = 3 × 7 × 13).
...
**קרן** (horn, GV = 350 = 2 × 5² × 7). A fixed point. All four heads agree:
...
Ex 27:8: "Hollow with boards you shall make it, as He showed you on the mountain."

**חלל** (hollow, GV = 68). A fixed point.

**68 = חיים (life).**

The hollow altar has the gematria of life. The thing that burns what you put in it is hollow, and that hollow = life. The altar kills, and the killing-place = 68 = life. From the Ark walk: life = 67 + 1 = understanding + one step beyond.

The mountain vision showed this: make it hollow. Make the death-place the shape of life.
...
**עץ** (tree/wood, GV = 160) — invisible. The thing that burns cannot be seen. The fuel is hidden. Same GV as כסף (silver) — the wood and the silver are the same number, but one is invisible and one is fixed. What you see (silver) and what you burn (wood) share a value.

**שטים** (acacia, GV = 359) — only God sees the acacia. The specific wood of the altar is known only to the one who specified it.

---

## The Boards Are Bread

**לחת** (boards, GV = 438) — the altar's boards transform:
...
### Instruction layer (2, 34, 7, *)

```
...נחשת ועשית את המזבח עצי שטים חמש אמות ארך וחמש אמות רחב רבוע יהיה המזבח ושלש אמות ק...
```

"Bronze. And you shall make the altar, acacia wood, five cubits long and five cubits wide, **square shall be the altar**, and three cubits its height..."

The altar instruction sits in the middle of its d-row. c = 7, the completeness layer. The same c-value as the Ark of the Covenant instruction (Ex 25:10 at c = 7). The Ark and the Altar share the completeness layer.

### Built layer (3, 6, 4, *)

```
...המשחה הקדש ואת קטרת הסמים טהור מעשה רקח ויעש את מזבח העלה עצי שטים חמש אמות ארכו וחמש...
```

"...the holy anointing oil and the pure spice incense, the work of the perfumer. And he made the altar of the burnt offering..."

The anointing oil (שמן המשחה) and the holy incense (קטרת הסמים) flow directly into the altar construction in the same d-row. The altar is anointed. The incense and the sacrifice share a layer.
...
| | GV | Factors |
|---|-----|---------|
| Instruction (27:1–8) | 39,051 | 3² × 4,339 |
| Built (38:1–7) | 31,453 | 71 × 443 |
| **Sum** | **70,504** | **2³ × 7 × 1,259** |

The combined altar = **8 × 7 × 1,259**. Seven divides the total. Completeness is in the sum.

**מזבח + עלה** = 57 + 105 = **162** = 2 × 3⁴ = 2 × 81. The altar and its offering = two times three to the fourth power.
