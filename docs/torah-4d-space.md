...
The Torah letter count of 304,850 = 2 × 5² × 7 × 13 × 67 admits 123 four-factor decompositions (41 non-trivial). Only one contains all three of 7, 13, and 67 simultaneously:
...
The factorization is not the only way to read the space. 304,850 = 2 × 5² × 7 × 13 × 67 admits 123 four-factor decompositions in total, of which 41 are non-trivial (all dimensions greater than 1). Only one contains all three of {7, 13, 67}:

**[7 × 50 × 13 × 67]**

The 50 is forced. There is no second choice.

An exhaustive survey of all 41 non-trivial lenses reveals three findings:

**The aleph-tav knows where 7 is.** Of the 41 non-trivial lenses, 21 have a clean first axis — את never straddles the axis-0 boundary. Every lens with 7 as axis-0 is clean. Lenses with 5 as axis-0 leak: one crossing. The two-letter word that stitches the space together recognizes the seven-day boundary even under alternative geometries.

**The fold depends only on the first factor.** Folding along axis-0 and checking whether the 26 Torah/YHWH ELS milemarkers mirror to meaningful positions, the result is determined entirely by how many pieces the first axis cuts. The internal arrangement of the remaining factors is irrelevant. All lenses with 7 as axis-0 produce the same fold: 4 self-mirrors, ÷13 rate of 26.9% (3.5× chance). All lenses with 2 as axis-0 produce a different fold: 0 self-mirrors, ÷13 at chance. The fold is about the *size of the cut*, not the shape of what's inside.
...
- Of 123 four-factor decompositions (41 non-trivial), exactly one contains {7, 13, 67}
- The aleph-tav respecting 7-boundaries even in alternate lenses where 7 is not the primary axis
- Fold signal depending only on the first factor — the internal geometry is irrelevant for the fold
- Alternate lens [10 × 13 × 35 × 67] centering on Yom Kippur (Lev 16:29) — the Day of Atonement
